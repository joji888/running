    ...
    <div v-loading="loading">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="上课时间" prop="cTime">
                <el-time-picker placeholder="选择时间" v-model="ruleForm.cTime" style="width: 50%;">
                </el-time-picker>
            </el-form-item>
...
<script>
    export default {
                    ...
                    if (valid) {
                        ...
                        this.$refs[formName].validate((valid) => {
                            if (valid) {
                                console.log(this.ruleForm)
                                let _this=this;
                                this.$http.post('course/update',this.ruleForm).then(function (res) {
                                    console.log(res)
        ...
        mounted() {
            ...
            let _this=this;
            this.$http.get('course/searchById',{
                params:{
                    cId:_this.cId
                }
            }).then(function (res) {
